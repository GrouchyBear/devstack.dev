        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                @if(Auth::guest())
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}" style="color: #9D3E30;">DevStack</a>

                @else

                    <a class="navbar-brand" href="{{ url('feed') }}" style="color: #9D3E30;">DevStack</a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li><a href="{{ url('create') }}" class="dd-lr"><i class="fa fa-wpforms" aria-hidden="true"></i> New</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle dd-t" data-toggle="dropdown" role="button" aria-expanded="false" style="position:relative; padding-left:50px;">
                            <img src="{{ Gravatar::src(Auth::user()->email, 32) }}" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%">
